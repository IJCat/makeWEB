...
class User {
  ...
  // getter setter 안의 변수 이름을 다르게 해야 콜스택이 차지 않는다.
  // User 클르스에는 firstName, lastName, _age 3개의 filed가 있다.
  get age() {
    return this._age;
  }
...
// Too soon!
// mozilla 사이트에서 확인
// safari에서도 지원이 안됨. 완전 최신
console.log('--- 3. Field(public, private) ---');
class Experiment {
  publicField = 2;
  #privateField = 0;
}
